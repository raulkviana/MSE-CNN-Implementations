...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md26}{}\doxysection{\texorpdfstring{7. Demo}{7. Demo}}\label{index_autotoc_md26}
\hypertarget{index_autotoc_md27}{}\doxysection{\texorpdfstring{8. Contributions}{8. Contributions}}\label{index_autotoc_md27}
Feel free to contact me through this \href{raulviana@ua.pt}{\texttt{ email}} or create either a issue or pull request to contribute to this project \texorpdfstring{$^\wedge$}{\string^}\texorpdfstring{$^\wedge$}{\string^}.\hypertarget{index_autotoc_md28}{}\doxysection{\texorpdfstring{9. License}{9. License}}\label{index_autotoc_md28}
This project license is under the \mbox{[}MIT License\mbox{]}(LICENSE).\hypertarget{index_autotoc_md29}{}\doxysection{\texorpdfstring{10. TODO}{10. TODO}}\label{index_autotoc_md29}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{index_autotoc_md30}{}\doxysection{\texorpdfstring{11. References}{11. References}}\label{index_autotoc_md30}
