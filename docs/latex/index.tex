...
\begin{DoxyItemize}
\item \doxylink{namespacedemo}{Demo}
\item Quickstart
\item 1. Introduction
...
\item 10. References
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{index_autotoc_md4}{}\doxysection{\texorpdfstring{Demo}{Demo}}\label{index_autotoc_md4}
Apply the MSE-\/\+CNN in your own pictures with its demo here\+: \href{https://kevinmevin-demo-mse-cnn.hf.space}{\texttt{ https\+://kevinmevin-\/demo-\/mse-\/cnn.\+hf.\+space}}\hypertarget{index_autotoc_md5}{}\doxysection{\texorpdfstring{Quickstart}{Quickstart}}\label{index_autotoc_md5}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md6}{}\doxysection{\texorpdfstring{1. Introduction}{1. Introduction}}\label{index_autotoc_md6}
...
Fig. 2\+: MSE-\/\+CNN benefits
 ...
 \hypertarget{index_autotoc_md7}{}\doxysection{\texorpdfstring{2. Theorectical Background}{2. Theorectical Background}}\label{index_autotoc_md7}
\hypertarget{index_autotoc_md8}{}\doxysubsection{\texorpdfstring{2.\+1 Partitioning in VVC}{2.1 Partitioning in VVC}}\label{index_autotoc_md8}
...
Fig. 4\+: Partitioning in VVC
 ...
 \hypertarget{index_autotoc_md9}{}\doxysubsection{\texorpdfstring{2.\+2 MSE-\/\+CNN}{2.2 MSE-CNN}}\label{index_autotoc_md9}
...
{\bfseries{Note}}\+: Details about how to load model coefficients can be found \doxysectlink{md_pages__doxygen_2modelcoefpage}{here}{0}.\hypertarget{index_autotoc_md10}{}\doxysubsubsection{\texorpdfstring{2.\+2.\+1 Architecture}{2.2.1 Architecture}}\label{index_autotoc_md10}
...
Note\+: For more details regarding these layers check \mbox{[}1\mbox{]}\hypertarget{index_autotoc_md11}{}\doxysubsubsection{\texorpdfstring{2.\+2.\+2 Loss Function}{2.2.2 Loss Function}}\label{index_autotoc_md11}
...
Results with weighted average for F1-\/score, recall and precision.\hypertarget{index_autotoc_md17}{}\doxysubsection{\texorpdfstring{4.\+2 Confusion matrices}{4.2 Confusion matrices}}\label{index_autotoc_md17}
\hypertarget{index_autotoc_md18}{}\doxysubsubsection{\texorpdfstring{4.\+2.\+1 Stages 2 and 3}{4.2.1 Stages 2 and 3}}\label{index_autotoc_md18}
   

Fig. 10\+: Confusion matrix results with the testing data in stages 2 and 3

 \hypertarget{index_autotoc_md19}{}\doxysubsubsection{\texorpdfstring{4.\+2.\+2 Stages 4 and 5}{4.2.2 Stages 4 and 5}}\label{index_autotoc_md19}
   

Fig. 11\+: Confusion matrix results with the testing data in stages 4 and 5

 \hypertarget{index_autotoc_md20}{}\doxysubsubsection{\texorpdfstring{4.\+2.\+3 Stage 6}{4.2.3 Stage 6}}\label{index_autotoc_md20}
  

Fig. 12\+: Confusion matrix results with the testing data in stage 6

 \hypertarget{index_autotoc_md21}{}\doxysubsection{\texorpdfstring{4.\+3 Y-\/\+PSNR, Complexity Reduction and Bitrate with test data}{4.3 Y-PSNR, Complexity Reduction and Bitrate with test data}}\label{index_autotoc_md21}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{4}{|X[-1]}|}
\hline
...
{\bfseries{These results were obtained with the \"{}medium\"{} configuration for the multi-\/thresholding method.}}\hypertarget{index_autotoc_md22}{}\doxysection{\texorpdfstring{5. Relevant Folders and files}{5. Relevant Folders and files}}\label{index_autotoc_md22}
\hypertarget{index_autotoc_md23}{}\doxysubsection{\texorpdfstring{5.\+1 Folders}{5.1 Folders}}\label{index_autotoc_md23}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{index_autotoc_md24}{}\doxysubsection{\texorpdfstring{5.\+2 Files in src folder}{5.2 Files in src folder}}\label{index_autotoc_md24}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{index_autotoc_md25}{}\doxysection{\texorpdfstring{6. Installation of dependencies}{6. Installation of dependencies}}\label{index_autotoc_md25}
In order to explore this project, it is needed to first install of the libraries used in it.\hypertarget{index_autotoc_md26}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{index_autotoc_md26}
...
\begin{DoxyEnumerate}
\item Enjoy! \+:)
\end{DoxyEnumerate}\hypertarget{index_autotoc_md27}{}\doxysubsection{\texorpdfstring{Package Distributions}{Package Distributions}}\label{index_autotoc_md27}
...
\end{DoxyEnumerate}\hypertarget{index_autotoc_md28}{}\doxysection{\texorpdfstring{7. Contributions}{7. Contributions}}\label{index_autotoc_md28}
Feel free to contact me through this \href{raulviana@ua.pt}{\texttt{ email}} or create either a issue or pull request to contribute to this project \texorpdfstring{$^\wedge$}{\string^}\texorpdfstring{$^\wedge$}{\string^}.\hypertarget{index_autotoc_md29}{}\doxysection{\texorpdfstring{8. License}{8. License}}\label{index_autotoc_md29}
This project license is under the \mbox{[}MIT License\mbox{]}(LICENSE).\hypertarget{index_autotoc_md30}{}\doxysection{\texorpdfstring{9. TODO}{9. TODO}}\label{index_autotoc_md30}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{index_autotoc_md31}{}\doxysection{\texorpdfstring{10. References}{10. References}}\label{index_autotoc_md31}
